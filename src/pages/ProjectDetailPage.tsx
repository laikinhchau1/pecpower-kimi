...
const projectDetails = {
  project1: {
    vi: {
      ...
      description: 'Nhà máy thủy điện Sông Ba là một trong những cơ sở thủy điện lớn nhất tại miền Trung Việt Nam, đóng vai trò quan trọng trong việc cung cấp năng lượng sạch cho khu vực. Dự án được khởi công xây dựng từ năm 2015 và chính thức vận hành thương mại từ năm 2018.',
      features: [
        'Công suất lắp máy: 220 MW',
        'Sản lượng điện trung bình: 850 triệu kWh/năm',
        'Chiều cao đập: 95 mét',
        'Diện tích lưu vực: 2,850 km²',
        'Hệ thống 2 tổ máy tuabin Francis',
        'Hệ thống giám sát SCADA tự động hóa',
        'Đường kính đường hầm dẫn nước: 6 mét',
        'Công suất phát điện tối đa: 220 MW',
      ],
      impact: 'Cung cấp điện cho hơn 400,000 hộ gia đình và góp phần giảm phát thải CO2 khoảng 700,000 tấn/năm. Dự án cũng tạo ra hơn 500 việc làm trực tiếp và gián tiếp cho ngườ dân địa phương.',
      technologies: [
        'Tuabin Francis hiệu suất cao (>94%)',
        'Hệ thống điều khiển tự động',
        'Công nghệ giảm thiểu tác động môi trường',
        'Hệ thống cá di chuyển (fish ladder)',
      ],
    },
    en: {
      ...
      completed: '2018',
      status: 'Operational',
      description: 'The Sông Ba Hydropower Plant is one of the largest hydroelectric facilities in Central Vietnam, playing a crucial role in providing clean energy to the region. Construction began in 2015 and commercial operations started in 2018.',
      features: [
        'Installed capacity: 220 MW',
        'Average annual output: 850 million kWh',
        'Dam height: 95 meters',
        'Catchment area: 2,850 km²',
        '2 Francis turbine units',
        'SCADA automated monitoring system',
        'Penstock diameter: 6 meters',
        'Maximum power output: 220 MW',
      ],
      impact: 'Powers over 400,000 households and contributes to reducing CO2 emissions by approximately 700,000 tons/year. The project also created over 500 direct and indirect jobs for local residents.',
      technologies: [
